...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('relief_camp_facilities', function (Blueprint $table) {
            ...
            $table->boolean('sufficient_plates_glasses')->default(true);
            ...
            $table->string('date_visit_of_health')->nullable();
            $table->string('date_visit_of_phed')->nullable();
            $table->string('date_visit_of_social_welfare')->nullable();
            $table->string('date_visit_of_cafpd')->nullable();
            $table->string('date_visit_of_edu')->nullable();
            $table->string('date_visit_of_pow')->nullable();
            $table->string('date_visit_of_mahud_ceo_adc')->nullable();
