...
class ReliefCampFacilityController extends Controller
{
    ...
    public function createOrUpdateFacilities(Request $request){
        ...
        if($relief_camp_facilities==null){
            ...
            $relief_camp_facilities->separate_kitchen=$request['separate_kitchen']=='yes'?true:false;
            $relief_camp_facilities->open_space=$request['open_space']=='yes'?true:false;
            ...
            $relief_camp_facilities->sufficient_cooking_utensils=$request['sufficient_cooking_utensils']=='yes'?true:false;
            ...
            $relief_camp_facilities->number_of_bedsheets=$request['number_of_badsheets'];
            ...
            $relief_camp_facilities->sufficient_lighting_facility=$request['sufficient_lighting_facility']=='yes'?true:false;
            ...
            $relief_camp_facilities->sufficient_plates_glasses=$request['sufficient_plates_glasses']=='yes'?true:false;
            ...
            $relief_camp_facilities->availability_of_veg_in_days=$request['availability_of_veg_in_days'];
            $relief_camp_facilities->safe_drinking_water=$request['safe_drinking_water']=='yes'?true:false;
            $relief_camp_facilities->provisioning_of_supplement=$request['provisioning_of_supplement']=='yes'?true:false;
