       ...
       //dd($relief_camp_facilities);
        ...
        foreach($relief_camp_facilities as $relief_camp_facility){
            ...
            ReliefCampFacility::create([
                ...
                'water_avail_ratio'=>$relief_camp_facility['water_availability_ratio'],
                'number_of_toilets'=>$relief_camp_facility['number_of_toilets'],
                'toilet_ratio_per_person'=>$relief_camp_facility['toilet_ratio'],
                'number_of_buckets'=>$relief_camp_facility['number_of_buckets'],
                'bucket_ratio_per_person'=>$relief_camp_facility['bucket_ratio_per_persons'],
                'number_of_mugs'=>$relief_camp_facility['number_of_mugs'],
                'mug_ratio_per_person'=>$relief_camp_facility['mug_ratio_per_persons'],
                ...
                'mattress_ratio_per_person'=>$relief_camp_facility['mattress_ratio_per_persons'],
                'number_of_badsheets'=>$relief_camp_facility['number_of_bedsheets'],
                'badsheet_ratio_per_person'=>$relief_camp_facility['bedsheet_ratio_per_persons'],
                'number_of_pillows'=>$relief_camp_facility['number_of_pillows'],
                'pillow_ratio_per_person'=>$relief_camp_facility['pillow_ratio_per_persons'],
                'number_of_blankets'=>$relief_camp_facility['number_of_blankets'],
                'blanket_ratio_per_person'=>$relief_camp_facility['blanket_ratio_per_persons'],
                'number_of_mosquitos'=>$relief_camp_facility['number_of_mosquito_nets'],
                'mosquito_ratio_per_person'=>$relief_camp_facility['mosquito_net_ratio_per_persons'],
                ...
                'fans_ratio_per_person'=>$relief_camp_facility['fan_ratio_per_persons'],
                'sufficient_plates_glases'=>strcasecmp($relief_camp_facility['sufficient_plates_and_glasses_available'],'yes')==0 ||strcasecmp($relief_camp_facility['sufficient_plates_and_glasses_available'],'y')==0 ?true:false,
                ...
                'per_of_students_linked_to_school'=>$relief_camp_facility['per_of_students_linked_to_school'],
                ...
                'per_child_linked_anganwadi'=>$relief_camp_facility['per_of_children_linked_to_anganwadi'],
                ...
                'per_of_pregnant_women_linked_health'=>$relief_camp_facility['per_of_pregnant_women_linked_to_health_facilities'],
                ...
                'per_of_disabled_person_liked_facility'=>$relief_camp_facility['per_of_specially_abled_persons_linked'],
                ...
                'per_of_child_separated_parents_linked_sw'=>$relief_camp_facility['per_of_separated_children_linked'],
